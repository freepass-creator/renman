...
| 날짜 | 작업자 | 내용 | 상태 |
|---|---|---|---|
| 2026-08-06 | → **다음 작업 (판단 먼저)** | ① `docs/AUDIT-2026-08-06.md` §6-3 — 증차신청·공문을 **업무로 볼 것인가** ② §6-4 — 근태·공지를 담을 «전 법인 행정» 자리를 만들 것인가 ③ §4-3 — 표 틀고정(열 숨김 vs 가로스크롤+첫열고정). **셋 다 사장님 결정 후 착수** | 대기 |
