...
| 날짜 | 작업자 | 내용 | 상태 |
|---|---|---|---|
| 2026-08-06 | → **Cursor 다음 작업** | **§4-11 경영관리=법인 원장 하나.** 4탭 폐지 · 상세패널 섹션(사업자·소재지·계좌·카드·임대차·직원·문서·보유자산) · `+법인 등록`=쓰기 zone(누르면 생성+패널) · `/admin` 폐지 흡수 · 규격=`docs/VEHICLE360-SPEC.md`. **한 번에** 할 것 | 인계 |
