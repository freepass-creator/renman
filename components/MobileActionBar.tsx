...
export function MobileActionBar() {
  ...
  return (
    <div style={{ position: 'fixed', left: 0, right: 0, bottom: 'var(--fp-tabbar-h, 0px)', zIndex: 55, background: C.taupeBg, borderTop: `1px solid ${C.line}`, boxShadow: '0 -2px 12px rgba(15,23,42,0.06)', paddingBottom: 'var(--fp-dock-safe, env(safe-area-inset-bottom))' }}>
