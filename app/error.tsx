    ...
    <div style={{ minHeight: '60vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
      <div style={{ maxWidth: 420, width: '100%', border: '1px solid #e2e2e0', borderRadius: 8, background: '#fff', padding: '28px 26px', boxShadow: '0 2px 12px rgba(0,0,0,0.06)', textAlign: 'center' }}>
        ...
        <div style={{ display: 'flex', gap: 8, justifyContent: 'center' }}>
          <button onClick={() => reset()} style={{ height: 40, padding: '0 18px', borderRadius: 6, border: 'none', background: '#1b2a4a', color: '#fff', fontSize: 16, fontWeight: 700, cursor: 'pointer' }}>다시 시도</button>
          <button onClick={() => { window.location.href = '/'; }} style={{ height: 40, padding: '0 18px', borderRadius: 6, border: '1px solid #d5d5d2', background: '#fff', color: '#1a1a1a', fontSize: 16, fontWeight: 700, cursor: 'pointer' }}>홈으로</button>
        </div>
